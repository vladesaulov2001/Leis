...
#define CFG_HACK_MESSAGE XorStr("[OK]")
#define CFG_HACK_NAME XorStr("Counter Strike: Global Offensive")
...
#define CFG_WEAPON_GLOBAL XorStr("Aimbot") //0xCB,7,0xBA12511B>("\x9C\xA9\xAC\xBE\xA0\xBE"+0xBA12511B).s
#define CFG_ESP_SETTINGS XorStr("Visuals") //0xD0,4,0x4FF5F65D>("\x95\xA2\xA2"+0x4FF5F65D).s
